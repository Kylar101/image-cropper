...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__js_main__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__css_bootstrap_min_css__ = __webpack_require__(12);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__css_cropper_min_css__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__css_cropper_min_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__css_cropper_min_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__css_sweetalert_css__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__css_sweetalert_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__css_sweetalert_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__css_main_scss__ = __webpack_require__(15);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_cropper__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_cropperjs__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_bootstrap_native__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_bootstrap_native___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_bootstrap_native__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__sweetalert_min__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__sweetalert_min___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__sweetalert_min__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_timers__ = __webpack_require__(9);
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(function () {
    ...
    function pageLoad() {
        __WEBPACK_IMPORTED_MODULE_4__utils__["a" /* default */].addSizingOptions()
        __WEBPACK_IMPORTED_MODULE_4__utils__["a" /* default */].addBrandingOptions()
    ...
    let helpModal = new __WEBPACK_IMPORTED_MODULE_3_bootstrap_native___default.a.Modal(helpModalID)
    ...
    let sizeModal = new __WEBPACK_IMPORTED_MODULE_3_bootstrap_native___default.a.Modal(sizeModalID)
    ...
    submitSizes.addEventListener('click', () => {
        ...
        __WEBPACK_IMPORTED_MODULE_4__utils__["a" /* default */].addLocalSizingOptions(JSON.parse(sizesValue.value))
    })

    let brandModalID = document.getElementById('brandModal')
    let brandModal = new __WEBPACK_IMPORTED_MODULE_3_bootstrap_native___default.a.Modal(brandModalID)
    ...
    submitBrands.addEventListener('click', () => {
        ...
        __WEBPACK_IMPORTED_MODULE_4__utils__["a" /* default */].addLocalBrandingOptions(JSON.parse(brandsValue.value))
    })
    ...
    for (var i = 0; i < myTabsCollection.length; i++) {
        new __WEBPACK_IMPORTED_MODULE_3_bootstrap_native___default.a.Tab(myTabsCollection[i], // our target
            { // our options
                height: true
            })
    }
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).on('change', 'input[name="dynamicSizes"]', function () {
        ...
        ratioList = __WEBPACK_IMPORTED_MODULE_4__utils__["a" /* default */].getSizeIdentifiers('dynamicSizes')

        var checking = [];
        imageSize = __WEBPACK_IMPORTED_MODULE_4__utils__["a" /* default */].getCheckBoxesSize('dynamicSizes')
        ...
        for (var i = 0; i < imageSize[0].length; i++) {
            if (__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.' + imageSize[0][i]).length < 1) {
                __WEBPACK_IMPORTED_MODULE_4__utils__["a" /* default */].addCropperHTMLSize(imageSize[0][i], imageSize[1][i], imageSize[2][i])
            } else {
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).on('change', 'input[name="dynamicBrands"],input[name="dynamicSizes"]', function () {
        var brandingDetails = __WEBPACK_IMPORTED_MODULE_4__utils__["a" /* default */].getBrandingOptions('dynamicBrands')
        ...
        if (branding) {
            ...
            for (let i = 0; i < cropperIdentifier.length; i++) {
                ...
                // adds new branding
                __WEBPACK_IMPORTED_MODULE_4__utils__["a" /* default */].calculateImageDimensions(brandingImage, cropperIdentifier[i], cropperWidth[i], cropperHeight[i])
            }
        ...
        if (data.method) {
            ...
            switch (data.method) {
                ...
                case 'getCroppedCanvas':
                    ...
                    let downloadModal = new __WEBPACK_IMPORTED_MODULE_3_bootstrap_native___default.a.Modal(downloadModalID)
                    ...
                    if (branding) {
                        __WEBPACK_IMPORTED_MODULE_4__utils__["a" /* default */].addBrandingAndDownload(brandingImage)
                    } else {
                        __WEBPACK_IMPORTED_MODULE_4__utils__["a" /* default */].downloadCanvas(this, 'cropper')
                    }
...
/* WEBPACK VAR INJECTION */(function(global) {var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;// Native Javascript for Bootstrap 3 v2.0.21 | © dnp_theme | MIT-License
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  */
    addCropperHTMLSize: (number, width, height) => {
        ...
        if (number) {
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#croppingArea').append(html);
        }
    },
   ...
   */
    ...
    getSizeIdentifiers: (chkboxName) => {
        ...
        for (var i = 0; i < options.length; i++) {
            ...
            sizeOptions.push(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(options[i]).data('number'))
        }
    ...
    */
    getCheckBoxesSize: (chkboxName) => {
        ...
        for (var i = 0; i < checkboxes.length; i++) {
            ...
            if (checkboxes[i].checked) {
                checkboxesNumber.push(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(checkboxes[i]).data('number'));
                checkBoxesUpper.push(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(checkboxes[i]).data('upper'));
                checkBoxesLower.push(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(checkboxes[i]).data('lower'));
                cropperObjects.push(`.${__WEBPACK_IMPORTED_MODULE_0_jquery___default()(checkboxes[i]).data('number')} > img`);
            }
        }
        // Return the arrays
        return [
    ...
    getBrandingOptions: (chkboxName) => {
        ...
        for (var i = 0; i < checkboxes.length; i++) {
            // And stick the checked ones onto an array...
            if (checkboxes[i].checked) {
                checkboxesLocation.push(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(checkboxes[i]).data('location'));
                checkBoxesNumber.push(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(checkboxes[i]).data('number'));
            }
        }
        // Return the arrays
    ...
    downloadCanvas: (link, filename) => {
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#closemodal').click();
    },
